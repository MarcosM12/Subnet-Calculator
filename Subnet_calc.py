...
def create_gui():
    ...
    #window['max_subnets'].Widget.configure(highlightcolor='red', highlightthickness=1)
...
def subnet_calc():
    ...
    while True:
        ...
        #Then, generate a random ip address that is part of this same class
        if event == 'class_A':
